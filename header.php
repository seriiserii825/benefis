                    ...
                    <div class="single-drop">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <label><i class="fa fa-cog"></i><?php pll_e('Валюта'); ?>: </label><span
                                            class="currenty"><?php echo do_shortcode('[woocommerce_currency_switcher_drop_down_box]'); ?></span>
...
<!--                                    <ul>--><?php //pll_the_languages(); ?><!--</ul>-->
                                    <?php if(!dynamic_sidebar('wpglobus')): ?>
                                        <h4 style="color: red">Место для виджета wpglobus</h4>
                                    <?php endif; ?>
                                </li>
                            </ul>
                        </nav>
                ...
                <div class="col-md-7 col-sm-6 col-xs-12">
                    <ul class="social_list">
                        <li><a target="_blank" href="https://www.pinterest.com/president2439/"><i
                                        class="fa fa-pinterest-square" aria-hidden="true"></i></a></li>
                        <li><a target="_blank" href="https://www.linkedin.com/in/benefisshopcom/"><i
                                        class="fa fa-linkedin-square" aria-hidden="true"></i></a></li>
                        <li><a target="_blank" href="https://www.youtube.com/channel/UC4GDpzOuLCaKcn1x3xjllgA/videos"><i
                                        class="fa fa-youtube-square" aria-hidden="true"></i></a></li>
                        <li><a target="_blank" href="https://twitter.com/benefisshop"><i class="fa fa-twitter-square"
                                                                                         aria-hidden="true"></i></a>
                        </li>
                        <li><a target="_blank"
                               href="https://www.instagram.com/explore/locations/1030092475/benefis-ballet-costumes/"><i
                                        class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        <li><a target="_blank" href="https://www.facebook.com/balletcostumesbenefis/"><i
            ...
            <div class="row">
                ...
                <div class="col-lg-7 col-md-6 col-sm-9 col-xs-12">
                    <div class="block-header">
                        ...
                        <div class="email"><a href="mailto:benefisshop.com"><i
                                        class="fa fa-envelope-o"></i>support@<span>benefisshop.com</span></a></div>
                    </div>
                    <div class="search-categori">
                        <div class="search-box">
                            <form action="#">
                                <input type="text" class="form-control input-sm" maxlength="64"
                                       placeholder="<?php pll_e('Введите поисковой запрос'); ?> ...">
