...
//		wp_register_script('jquery', get_template_directory_uri() . '/js/vendor/jquery-1.11.3.min.js');
...
//	add_action('wp_enqueue_scripts', 'load_scripts', 9);
//	function load_scripts()
//	{
//		wp_enqueue_script('wc-add-to-cart', get_template_directory_uri() . '/js/add-to-cart.js', ['jquery']);
//	}
